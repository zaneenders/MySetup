...
require("telescope").setup {
  extensions = {
    file_browser = {
      ...
      hijack_netrw = true, -- override default file vim filebroswer
      mappings = {
        ["i"] = {
...
vim.defer_fn(function()
  require('nvim-treesitter.configs').setup {
    ...
    ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'javascript', 'typescript', 'vimdoc', 'vim', 'bash', 'racket', 'swift' },
